  ...
  carwash: {
    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          { id: "tech123", title: "Мойка двигателя и моторного отсека с продувкой воздухом", desc: "(Производится по согласованию гостя и под его ответственность.", prices: [700, 750, 850, 900, 950] },
          { id: "euro123", title: "Мойка двигателя и моторного отсека с диэлектрическим составом", desc: "", prices: [2000, 2150, 2400, 2650, 2900] },
          { id: "lux123", title: "Обработка мотора консервантом koch", desc: "", prices: [1250, 1250, 1250, 1250, 1250] },
          { id: "quartz123", title: "Детейлинг мойка мотора", desc: "", prices: [4400, 5000, 5000, 5600, 5600] },
        ]
      },
      {
        id: "radiator",
    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: "scratch_remo", title: "Полировка + покрытие жидким стеклом", desc: "", prices: ["от 1000 ₽", "от 30000 ₽", "от 30000 ₽", "от 30000 ₽", "от 30000 ₽"] },
          { id: "scratc", title: "Полировка + керамическое покрытие", desc: "", prices: ["от 40000 ₽", "от 40000 ₽", "от 40000 ₽", "от 40000 ₽", "от 40000 ₽"] },
        ]
      },
      {
        id: "soundproofing",
