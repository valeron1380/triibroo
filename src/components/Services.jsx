    ...
    subcategories: [
      {
        ...
        title: "Мойка кузова",
        items: [
          { id: "tec", title: "Мойка мотоцикла", desc: "", prices: [400, 400, 400, 400, 400] },
          { id: "tech", title: "Бесконтактная мойка", desc: "Бесконтактная мойка (кузов, арки и коврики салона).", prices: [450, 500, 650, 700, 850] },
          { id: "euro", title: "Сухая/Двухфазная мойка", desc: "Двухфазная мойка кузова с использованием шампуня  (кузов, арки и коврики салона).", prices: [600, 700, 900, 1100, 1300] },
      ...
      },
      {
        ...
        items: [
          ...
          { id: "prem", title: "2х-фазный Комплекс", desc: "Мойка кузова с использованием шампуня для бережной мойки, арки, пороги, коврики, пылесос салона, чистка педалей,мойка стёкол, чернение резины", prices: [1200, 1300, 1500, 1800, 2000] },
          { id: "hitech", title: "НАНО 3ёх-фазный Комплекс", desc: "Мойка кузова с использованием шампуня для бережной мойки, химчистка дисков, пылесос салона, мойка стёкол стеклоочистителем, влажная уборка салона очищающим составом, обработка кожи салона кондиционером, уборка багажника, чистка педалей, чернение резины", prices: [2200, 2500, 2900, 3200, 3700] },
          { id: "pro", title: "Комплекс 'Зимний пакет'", desc: "Комплекc 'Стандарт', обезжирование кузова, полимерное покрытие кузова, пылесос багажника, мойка дисков и выхлопных труб, обработка силиконом резиновых уплотнителей, чистка педалей, чернение резины", prices: [2400, 2700, 3300, 3600, 4000] },
          { id: "ceramic_wash", title: "Комплекс INSIDE", desc: "Бесконтактная мойка кузова, протирка всех пластиковых поверхностей и использованием полироли, пылесоса салона, кондиционер кожи всех сидений и обшивок, уборка багажника, азонация салона", prices: [2200, 2400, 2600, 2800, 3100] },
        ]
      }
    ]
  },
    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { id: "polish_head", title: "Востановление цвета", desc: "Востановление цвета и блеска кузова, бесконтактная мойка, удаление паутинок, помутнений.", prices: ["от 5000 ₽", "от 7000 ₽", "от 10000 ₽", "от 15000 ₽", "от 18000 ₽"] },
          ...
          { id: "ppf", title: "Полировка Фар", desc: "Полировка Фар (задних фонарей, повторителей поворотников).", prices: ["от 600 ₽", "от 600 ₽", "от 600 ₽", "от 600 ₽", "от 600 ₽"] },
          { id: "remove_scratches", title: "Ручная чистка кузова Глиной Clay Magic", desc: "Глубоко очищает поверхность, удалчяет все стойкие и невидимые загрязнения, делая поверхность гладкой как стекло и кристально чистой.", prices: [2500, 3000, 3500, 4000, 4500] },
          { id: "remove_insects", title: "Полная образивная полировка ЛКП", desc: "Бесконтактная мойка, удалиние царапин, паутинок, затираний, помутнений, восстановление цвета и блеска.", prices: ["от 15000 ₽", "от 17000 ₽", "от 20000 ₽", "от 25000 ₽", "от 25000 ₽"] },
